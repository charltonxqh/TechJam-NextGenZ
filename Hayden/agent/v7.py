...
REC=[("dcn12",   DCN,"fm",16,S12,{}),
     ("dcn_x2",  DCN,"fm",16,S6, {"n_cross":2}),
     ("dcn_x4",  DCN,"fm",16,S6, {"n_cross":4}),
     ("dcn_h192",DCN,"fm",16,S6, {"hidden":192}),
     ("dcn_h64", DCN,"fm",16,S6, {"hidden":64}),
     ("listce",  FM, "listce",16,S6,{})]
P={"valid":{},"test":{}}; T={}
...
if rt["GAUC"]>0.6677:
    ...
    out=HERE/"state"/"submission_v7.csv"
